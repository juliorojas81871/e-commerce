  ...
  return (
    <>
      <div className="w-full bg-stone-200 py-5 relative">
        <div className="top-products w-4/5 m-auto grid lg:grids-cols-6 grid-cols-3 gap-5 justify-items-center my-10">
          <div className="products w-36 space-y-2">
        ...
        <div className="arrows absolute inset-y-1/2 flex justify-between w-full px-5">
          <div className="p-2 py-y bg-white rounded-full items-center">
            <AiOutlineLeft />
          </div>
          <div className="p-2 py-y bg-white rounded-full items-center">
            <AiOutlineRight />
